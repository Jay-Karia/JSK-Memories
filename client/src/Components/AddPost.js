...
import forest_secondary from './images/secondary_forest_bg.jpg'
...
const AddPost = () => {
    ...
    return (
        <>
        <Container className="addContainer" align='center' sx={{border:'2px solid black', marginTop:'30px', border:'2px solid black', borderRadius:'9px', alignItems:"center", backgroundImage:`url(${forest_secondary})`, width:'40rem'}}>
            ...
            <Box component="form" sx={{ '& .MuiTextField-root': { m: 1, width: '20rem' }}} noValidate autoComplete="off">
                ...
                <div style={{display:'flex', alignItems:'center', justifyContent:'center', marginTop:'20px', border:'0.1px solid grey', padding:'10px', fontFamily:'roboto', borderRadius:'5px', width:'50%'}}>
                    <label htmlFor="selection of a file" style={{fontSize:'1.1rem', marginRight:'10px'}}>Upload File: </label>
                    <Button variant="contained" sx={{bgcolor:Colors.green[700], borderRadius:'30px'}} component="label"><FileUploadRoundedIcon/><input type="file" className="fileUpload" onChange={(e)=>{setFile(e.target.value)}} hidden/></Button>
                ...
                <Box display='flex' sx={{justifyContent:'center', alignItems:'center', marginBottom:'20px', marginTop:'20px'}}>
                    <Button endIcon={<AddBoxRoundedIcon fontSize='large'/>} variant="contained" sx={{bgcolor:Colors.green[900], fontSize:'large', borderRadius:'10px'}}>Add</Button>
                </Box>
            </Box>
        </Container>
        </>
